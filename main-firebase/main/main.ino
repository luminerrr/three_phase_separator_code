...
//  Serial.println(servoState);
  ...
  // Uncomment this for the first sensor
  
  // Serial.print(smoothing(calculateBMP(bmp0, 0)));
  // Serial.println(" <- Sensor Campuran");
  // Serial.print(" ;");
  // Uncomment this for the second sensor
  // Serial.println(smoothing2(calculateBMP(bmp2, 2)));

  Serial.println(smoothing(calculateBMP(bmp0, 0)));
  // Serial.println(" <- Sensor Minyak");
  // Serial.println(smoothing(calculateBMP(bmp0,0)), "; ",smoothing2(calculateBMP(bmp2,2)));
